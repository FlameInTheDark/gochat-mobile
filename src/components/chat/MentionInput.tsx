  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          isMobile
            ? 'rounded-2xl border border-input/80 bg-background/95 shadow-xs transition-colors focus-within:border-ring/70'
      ...
      >
        ...
        {/* Text editor row */}
        <div className={cn('flex gap-1', isMobile ? 'min-h-14 items-center px-2 py-1.5' : 'items-end px-3 py-2')}>
          {/* Paperclip button */}
          {onAttachClick && (
            <button
              type="button"
              ...
              className={cn(
                ...
                isMobile ? 'mobile-composer-button h-10 w-10 rounded-full active:bg-accent' : 'mb-0.5 h-7 w-7 rounded',
              )}
            >
          ...
          <div
            ...
            className={cn(
              'mention-editor flex-1 max-h-48 overflow-y-auto outline-none text-foreground leading-6 break-words',
              isMobile ? 'min-h-10 py-2 text-[16px]' : 'min-h-[28px] text-sm',
          ...
          {isMobile && (
            <button
              ...
              className="mobile-composer-button flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-primary transition-colors active:bg-primary/10 hover:text-primary/80 disabled:opacity-40"
            >
