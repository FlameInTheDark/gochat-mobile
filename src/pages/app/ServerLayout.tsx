...
import MobileServerWorkspace from '@/components/layout/mobile/MobileServerWorkspace'
...
export default function ServerLayout() {
  ...
  if (isMobile) {
    ...
    return <MobileServerWorkspace channels={resolvedChannels} serverId={serverId!} />
  }
